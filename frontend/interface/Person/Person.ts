...
export interface Employee {
  ...
  export interface Person {
    ...
    profile_picture: string | null;     // URL de la foto de perfil o null
    ...
    bank_account_number: number;        // Número de la cuenta bancaria
